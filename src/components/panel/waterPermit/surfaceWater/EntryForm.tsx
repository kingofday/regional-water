...
const EntryForm = ({
  ...
  const [find, finding] = useApi({
    autoCallUrl: data ? addreses.surfacewaterpermit.find(data.id) : undefined,
    onSuccess(res) {
  ...
  const handleSubmit = (values: any) => {
    ...
    if (!data) addOrUpdate.post(addreses.surfacewaterpermit.add, frmData);
    else addOrUpdate.put(addreses.surfacewaterpermit.update, frmData);
  };
